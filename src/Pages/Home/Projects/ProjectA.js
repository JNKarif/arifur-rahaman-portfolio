...
const ProjectA = () => {
    return (
        <div className='bg-gradient-to-r from-pink-300 to-purple-600'>
            <p className='text-3xl py-5 text-center '>BikeHub-Used bike buy/sell website
</p>
       ...
       <a href="#slide4" className="btn btn-circle">❯</a>
            ...
            <div className='px-10 pb-10'>
                <ol className='text-xl text-center font-bold'>
                    ...
                    <li> •	Summary: Different account authentication system for buyer and seller,
                        admin has admin dashboard where he can delete any user. Buyer/ Seller can sell or delete products, a buyer can pay and a seller can add images.</li>
                    <li> •	Functionality: JavaScript, React, Firebase, MongoDB, Express.js, CRUD, Tailwind CSS, daisyUI, dotenv.</li>
                    <li>•	Project Duration- November 2022 | <a href="https://bikehub-3a5dd.web.app/">Live Link</a>  | <a href="https://github.com/JNKarif/bikehub-client">Client-side-code</a>   | <a href="https://github.com/JNKarif/bikehub-server">Server-side-code</a>  </li>
                </ol>
            </div>
